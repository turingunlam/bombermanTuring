...
public class BombaExplotada extends Bomba {
	...
	public BombaExplotada(double xPos, double yPos, int rango, int tiempoDetonacion) {
		super(xPos, yPos, rango, tiempoDetonacion);
		rangoIzq = rangoDer = rangoArriba = rangoAbajo = rango;
		tiempoExplosion = 500;

		sprite = new Sprite(PATH, 32, 32);

		BufferedImage[] centroFrames = { sprite.getSprite(0, 1), sprite.getSprite(1, 1), sprite.getSprite(2, 1),
		...
		BufferedImage[] izqMedioFrames = { sprite.getSprite(0, 5), sprite.getSprite(1, 5), sprite.getSprite(2, 5),
		...
		BufferedImage[] izqPuntaFrames = { sprite.getSprite(6, 5), sprite.getSprite(7, 5), sprite.getSprite(8, 5),
		...
		BufferedImage[] derMedioFrames = { sprite.getSprite(0, 4), sprite.getSprite(1, 4), sprite.getSprite(2, 4),
		...
		BufferedImage[] derPuntaFrames = { sprite.getSprite(6, 4), sprite.getSprite(7, 4), sprite.getSprite(8, 4),
		...
		BufferedImage[] medioFrames = { sprite.getSprite(0, 2), sprite.getSprite(1, 2), sprite.getSprite(2, 2),
		...
		BufferedImage[] arribaPuntaFrames = { sprite.getSprite(0, 0), sprite.getSprite(1, 0), sprite.getSprite(2, 0),
		...
		BufferedImage[] abajoPuntaFrames = { sprite.getSprite(0, 3), sprite.getSprite(1, 3), sprite.getSprite(2, 3),
