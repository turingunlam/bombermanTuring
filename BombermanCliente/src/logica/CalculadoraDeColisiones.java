...
public class CalculadoraDeColisiones implements Serializable {
	private static final long serialVersionUID = 1L;

	public static void chequearColisiones(Mapa mapa) {
		ArrayList<Bomberman> bombermans = new ArrayList<Bomberman>(mapa.getBombermans().values());
